...
// Unit test utilities.
  ...
  var factorial = w.annotate (function (n) {return n > 1 ? n * factorial (n - 1) : n});

  print (factorial (5));

  print ('Events:');
  print (w.events.to_array().join ('\n'));

  var w2 = new d.debug.watcher();
//  w2.annotate (function () {

//  :: get divergence-rebase-lib

//  }) ();

  d.rebase (function (x) {return y >$> x + y});

  print (w2.events.elements.length);